...
int getMoveByIndex(int idx, int holePosition)
{
  ...
  // Since here we are trying REGULAR backtracking,
  // the ordering does not concern us.
  // In mediumCindy, the special ordering it has
  // gives it a much faster exploration of the state tree.
